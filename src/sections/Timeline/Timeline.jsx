              ...
              {items.map((item, index) => (
                ...
                >
                  ...
                  <div className="timeline-card stagger-fade">
                    ...
                    {item.type && (
                      <span className={item.type === 'cert' || item.type === 'achievement' ? `timeline-type ${item.type}` : 'timeline-type'}>
                        {item.type === 'cert' ? 'CERT' : item.type === 'achievement' ? 'ACHIEVEMENT' : 'EDUCATION'}
                      </span>
                    )}
                  </div>
                </article>
